...
namespace Abacus
{
    ...
    public static class Array2DExtensions
    {
        ...
        public static double[,] InsertRow(this double[,] matrix, IVector row, int rowPos)
        {
            return matrix.InsertRow(row.Values, rowPos);
        }
        ...
        {
            return MatrixDecomp.Svd.ComputeSvd(matrix);
        }
        ...
        public static double[] Multiply(this double[,] matrix, IVector vector)
        {
            return matrix.Multiply(vector.Values);
        }
